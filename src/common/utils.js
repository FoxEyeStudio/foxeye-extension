...
export const EthSign = 'eth-sign-switch';

export const SWITCH_ALERT_ID = [PhishingWebsites, MaliciousContract, TokenSafety, TargetCorrectness, ApproveReminder, EthSign];
